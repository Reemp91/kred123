...
REPOID = 'repository.kred123'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://mailer.delivery/leia/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://mailer.delivery/leia/zips/repository.kred123/'
#########################################################
